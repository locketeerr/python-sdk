...
class ValidationErrorDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "parameter", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "parameter", "message", ], str]):
