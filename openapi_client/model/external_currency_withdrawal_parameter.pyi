...
class ExternalCurrencyWithdrawalParameter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "code", "name", "required", "example", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "code", "name", "required", "example", ], str]):
