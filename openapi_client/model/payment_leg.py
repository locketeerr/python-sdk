...
class PaymentLeg(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "amount", "dateCreated", "reference", "currency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "amount", "dateCreated", "reference", "currency", ], str]):
