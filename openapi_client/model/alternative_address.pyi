...
class AlternativeAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protocol", "address", "tag", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["protocol", "address", "tag", "uri", ], str]):
