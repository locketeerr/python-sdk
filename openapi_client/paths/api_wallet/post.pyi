...
# body param
SchemaForRequestBodyApplicationJson = WalletRequest


request_body_wallet_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = Wallet
...
class BaseApi(api_client.Api):
    ...
    def _wallet_create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_wallet_request.serialize(body, content_type)
...
class WalletCreate(BaseApi):
    ...
    def wallet_create(
        ...
        return self._wallet_create_oapg(
            body=body,
