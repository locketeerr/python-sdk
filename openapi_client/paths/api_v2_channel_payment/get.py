...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MerchantChannelPayment']:
            return MerchantChannelPayment

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['MerchantChannelPayment'], typing.List['MerchantChannelPayment']],
    ...
    def __getitem__(self, i: int) -> 'MerchantChannelPayment':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_v2_channel_payment_get_oapg(
        self,
...
class ApiV2ChannelPaymentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_v2_channel_payment_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_v2_channel_payment_get(
        ...
        return self._api_v2_channel_payment_get_oapg(
